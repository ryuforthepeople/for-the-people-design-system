...
const preview: Preview = {
  parameters: {
    ...
    designToken: {
      defaultTab: 'Colors',
      styleInjection: '@import url("https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&family=Manrope:wght@400;500;600;700;800&display=swap");',
    },
  },
  decorators: [
    (story) => ({
